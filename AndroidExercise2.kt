 ...
 **/
    ...
    println("the price for $child is \$${ticketPrice(child, isMonday)}.")
    println("the price for $adult is \$${ticketPrice(adult, isMonday)}.")
    println("the price for $senior is \$${ticketPrice(senior, isMonday)}.")
    }
